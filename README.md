...
```mermaid
flowchart LR
  A[Backend Dev] --> B[Java / Spring Boot]
  A --> C[Python / Django, FastAPI]

  D[Teaching] --> E[Java & Spring Boot]
  D --> F[Python & Django]
  D --> G[AWS Hands-on]

  H[Design & Docs] --> I[ER Diagrams]
  H --> J[Use-case Specs]
  H --> K[Screen Flows]
...
<div align="left"> <img height="170px" src="https://github-readme-stats.vercel.app/api?username=yoshiayu&theme=vue-dark&show_icons=true&count_private=true" /> <img height="170px" src="https://github-readme-stats.vercel.app/api/top-langs/?username=yoshiayu&theme=vue-dark&layout=compact" /> </div>
活動内容 / Activities
...
<details> <summary>詳しい活動内容 / More details</summary>
...
```mermaid
flowchart TD
  Now[Now - Java / Spring Boot / Django / AWS] --> S1[Step 1 - GraphQL API with Spring Boot 3]
  S1 --> S2[Step 2 - FastAPI and Docker Microservices]
  S2 --> S3[Step 3 - Next.js and TypeScript Frontend]
  S3 --> S4[Step 4 - AWS CDK TypeScript IaC]
  S4 --> S5[Step 5 - Flutter-based Mobile Training Apps]
```
...
![github-contribution-grid-snake](https://raw.githubusercontent.com/yoshiayu/yoshiayu/output/github-contribution-grid-snake.svg)
